...
# HAZARD_SIZE = 0.25
# for x in range(5):
#     pos_x = -1 + HAZARD_SIZE*x
#     for j in range(2):
#         pos_y = 0.125 - HAZARD_SIZE*j
#         HAZARD_LOCATIONS.append((pos_x, pos_y))
# PILLAR_LOCATIONS = []
# PILLAR_SIZE = 0.25
# for j in range(6):
#     pos_y = 1.25 - 2*PILLAR_SIZE*j
#     PILLAR_LOCATIONS.append((-1.25, pos_y))
#     PILLAR_LOCATIONS.append((1.25, pos_y))
# for i in range(6):
#     pos_x = -1.25 + 2*PILLAR_SIZE*i
#     PILLAR_LOCATIONS.append((pos_x, 1.75))
#     PILLAR_LOCATIONS.append((pos_x, -1.75))
...
# for x in range(3):
    ...
    # HAZARD_LOCATIONS.append((pos_x, -0.125))
# HAZARD_SIZE = 0.175
# for x in range(5):
    # pos_x = -0.675 + HAZARD_SIZE*x
HAZARD_SIZE = 0.175
for x in range(4):
    pos_x = -0.675 + HAZARD_SIZE*x
# HAZARD_SIZE = 0.15
# for x in range(4):
#     pos_x = -0.65 + HAZARD_SIZE*x
    HAZARD_LOCATIONS.append((pos_x, 0))
PILLAR_LOCATIONS = []
PILLAR_SIZE = 0.25
for j in range(5):
    ...
    PILLAR_LOCATIONS.append((1, pos_y))
for i in range(4):
    pos_x = -0.75 + 2*PILLAR_SIZE*i
    PILLAR_LOCATIONS.append((pos_x, 1.5))
    PILLAR_LOCATIONS.append((pos_x, -1.5))

class ContextualDoggoLevel1(BaseTask):
    """
    ...
    def __init__(
        ...
        self.placements_conf.extents = np.array([-0.3, -0.3, -0.3, -0.3])
        # self.placements_conf.extents = np.array([-0.4, -0.6, -0.4, -0.6])
        # self.placements_conf.extents = np.array([-1., -1., -0.9, -0.9])
        # self.placements_conf.extents = np.array([-1.1, -1.6, -1.0, -1.5])
...
tasks = {
    "ContextualDoggoLevel1": ContextualDoggoLevel1
}
