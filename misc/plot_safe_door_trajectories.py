    ...
    algorithms = {
        "safety_door_2d_narrow": {
            "CCURROTL_D=25_DCE=7.5": {
                ...
                "model": "PPOLag_DELTA=25.0_DELTA_C=0.0_DELTA_C_EXT=7.5_METRIC_EPS=0.5",
                "color": "blue",
            },
            "CCURROTL_D=30_DCE=7.5": {
                "algorithm": "constrained_wasserstein",
                "label": "CCURROTL_D=30_DCE=7.5",
                "model": "PPOLag_DELTA=30.0_DELTA_C=0.0_DELTA_C_EXT=7.5_METRIC_EPS=0.5",
                "color": "green",
            },
            "CCURROTL_D=25_DCE=10.0": {
                "algorithm": "constrained_wasserstein",
                "label": "CCURROTL_D=25_DCE=10.0",
                "model": "PPOLag_DELTA=25.0_DELTA_C=0.0_DELTA_C_EXT=10.0_METRIC_EPS=0.5",
                "color": "red",
            },
            "CCURROTL_D=30_DCE=10.0": {
                "algorithm": "constrained_wasserstein",
                "label": "CCURROTL_D=30_DCE=10.0",
                "model": "PPOLag_DELTA=30.0_DELTA_C=0.0_DELTA_C_EXT=10.0_METRIC_EPS=0.5",
                "color": "gray",
            },
            # "DEF_Lag": {
            #     "algorithm": "default",
